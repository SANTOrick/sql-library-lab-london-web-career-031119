...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(characters.name) FROM characters JOIN series ON series.id = characters.series_id JOIN books ON books.series_id = series.id WHERE characters.series_id == books.series_id"
end
